...
async function formHandle(e) {
  ...
  try{
  await axios.post(BACKEND_URL + '/admin/sessions', jsonData, axiosConfig)
...
<section className="relative flex flex-wrap lg:h-screen lg:items-center pt-3 pl-3 pr-3 pb-2 bg-primaria">
  <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
    <div className="mx-auto max-w-lg text-center">
      ...
      <h1 className="text-white text-2xl font-bold text-white sm:text-2xl md:text-2xl">ADM</h1>
    ...
    <form onSubmit={async function (e) { await formHandle(e) }} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-300">
          Não tem uma conta?
          <a className="underline" href="/create/admin/send">Criar Conta</a>
        </p>
      ...
      <div className="flex items-right">
        <p className="text-sm text-gray-300 ml-auto">
          <a className="underline" href="/admin/password/forgot">Esqueci minha Senha</a>
        </p>
