...
if (Cookies.get('AuthorizationAdmin') && window.location.pathname == '/admin/points/stores/order') {
  try {
    await axios.post(BACKEND_URL + '/admin/order/store', { 'id': id }, axiosConfig)
...
export default function PointsAdminStoreOrders() {
          ...
          return (
            ...
            <article
              ...
              <div>
                ...
                <p className="text-sm text-gray-500"><span className="text-primaria">Profissional:</span> {item.customer}</p>
                <p className="text-sm text-gray-500"><span className="text-primaria">Consultor:</span> {item.consulant}</p>
