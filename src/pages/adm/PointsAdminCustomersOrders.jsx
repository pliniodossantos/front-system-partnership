...
if (Cookies.get('AuthorizationAdmin') && window.location.pathname == '/admin/points/customers/order') {
  try {
    await axios.post(BACKEND_URL + '/admin/order/customer', { 'id': id }, axiosConfig)
...
export default function PointsAdminCustomersOrders() {
