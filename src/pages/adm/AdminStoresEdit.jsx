...
function formDataToJsonMapper(id, name, email, cnpj, birthday) {
  let formatedData = {
    id: id,
    name: name,
    email: email,
...
async function formHandle(e) {
  ...
  const jsonData = formDataToJsonMapper(idC, name, email, cnpj, birthday);



  try {
    await axios.put(BACKEND_URL + '/admin/stores', jsonData, axiosConfig)
