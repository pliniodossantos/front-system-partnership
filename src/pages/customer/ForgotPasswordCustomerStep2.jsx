...
async function formHandle(e) {
  ...
  try {
    await axios.patch(BACKEND_URL + '/customers/password/reset', jsonData, axiosConfig)
...
export default function ForgotPasswordCustomerStep2() {
  return (
    <>
      
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg text-center">
          <h1 className="text-2xl font-bold sm:text-3xl">Redefinição de senha</h1>
