...
if (Cookies.get('AuthorizationConsulant')) {
  ...
  try {
    await axios.get(BACKEND_URL + '/consulants/orders/' + decodedId.sub, axiosConfig)
...
export default function PointsConsulant() {
   if (!Cookies.get('AuthorizationConsulant')) {
    ...
    <>
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg text-center mb-5">
          <h1 className="text-2xl font-bold sm:text-3xl text-primaria">Meus Pontos</h1>
        </div>
