...
async function formHandle(e) {
  ...
  try {
    await axios.post(BACKEND_URL + '/consulants/password/forgot', jsonData, axiosConfig)
    window.location = '/consulant/password/reset'
...
export default function ForgotPasswordConsulantStep1() {
  return (
    <>
